...
def get_args_parser():
    ...
    parser.add_argument('--epochs', default=30, type=int)           #50
    parser.add_argument('--lr_drop', default=20, type=int)          #40             
    ...
    parser.add_argument('--resume', default='weights/r50_1.pth', help='resume from checkpoint')             #!!!!!
